...
public class AutoChico extends Automovil{
 String color = "";

public AutoChico(int identificador, int cantidadDeRuedas, int cantidadDeVentanas, int cantidadDePuertas, String color) {
